      ...
      <div class="col-lg mb-4">
        <div class="card h-100">
          ...
          <form method="post" action="registro.php">
            ...
            <input type="text" id="nickRegistro" name="nickRegistro" class="form-control" required>
            ...
            <input type="email" id="mailRegistro" name="mailRegistro" class="form-control" required>
            ...
            <textarea id="mensajeRegistro" class="form-control" maxlength="300" name="mensajeRegistro" required></textarea>
